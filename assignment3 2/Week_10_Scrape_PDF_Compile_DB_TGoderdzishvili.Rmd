...
```{r}
#rsw comment - So, I can't run your code since the file paths point to your hard drive - D:/A DATA CLASS 2. Please create relative file paths so someone downloading your material from GitHub can run the code.
...
# text <- pdf_text("assets/pdfs/Asian_Indian_Women_NYT_LAT_USAT.PDF")
#writeLines(text, "assets/extracted_text/AIW.txt")
