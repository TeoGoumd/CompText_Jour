...
```{r}
library(tidyverse) #**rsw comment: OVERKILL! you've already loaded it three times!**
library(readtext)
library(ggplot2)
...
#join ai_w_dates and originals_w_dates and do the yearly counts. make sure you have 45 entries.
